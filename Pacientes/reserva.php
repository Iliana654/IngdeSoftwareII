...
$(document).ready(function() {
    ...
    $("#fecha-cita").change(function() {
        ...
        if (fecha) {
            $.ajax({
                ...
                method: 'POST',
                data: { fecha: fecha, especialidad: especialidadSeleccionada },
    ...
    $("#btn-continuar").click(function() {
        if (horarioSeleccionado) {
            window.location.href = `info_paciente.php?fecha=${$("#fecha-cita").val()}&especialidad=${especialidadSeleccionada}&idMedico=${horarioSeleccionado}`;
        } else {
