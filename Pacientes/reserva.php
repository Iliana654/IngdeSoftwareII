...
<body>
    ...
    <script>
        ...
        const horario = $(".btn-horario.selected").data("horario");
        const medico = $(".btn-horario.selected").data("medico");
        const hora = $(".btn-horario.selected").data("hora");

    // Llenar el formulario oculto y enviarlo
        $("#formulario-cita input[name='horario']").val(horario);
        $("#formulario-cita input[name='medico']").val(medico);
        $("#formulario-cita input[name='hora']").val(hora);

        $("#formulario-cita").submit();
        });
...
<form id="formulario-cita" action="formulario-cita.php" method="POST" style="display: none;">
